...
func (cfg *Config) ParseFlags(args []string) (*kingpin.Application, error) {
	...
	app.Flag("help-markdown", "Generate a markdown page.").Hidden().PreAction(func(context *kingpin.ParseContext) error {
